...
class MainActivity : AppCompatActivity() {
    ...
    fun shareMeme(view: View) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT,"Check out this funny Meme $currentImageUrl")
    ...
    private fun loadMemeData(){
        ...
        val jsonObjectRequest = JsonObjectRequest(Request.Method.GET, url, null,
                { response ->
                    ...
                    Glide.with(this).load(currentImageUrl).listener(object : RequestListener<Drawable> {
                        ...
                        override fun onLoadFailed(e: GlideException?,
                            ...
                            Toast.makeText(this@MainActivity,"Internet connection error",Toast.LENGTH_SHORT).show()
                            return false
                ...
                { error ->
                    ...
                    Toast.makeText(this@MainActivity,"Data connection is off.",Toast.LENGTH_SHORT).show()
                })
